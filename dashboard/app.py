...
if role == "👥 Sales Director (Org)":
    ...
    uploaded_file = st.file_uploader("Upload a new call recording directly from your browser (.wav, .mp3, .m4a, .ogg, .flac, .mpeg, .mpg):", type=["wav", "mp3", "m4a", "ogg", "flac", "mpeg", "mpg"])
